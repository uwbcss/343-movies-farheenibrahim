...
//   // Make stream safely — only if there's enough to skip
...
//   switch (commandType) {
//   case 'B':
//     return new Borrow(stream);
//   case 'R':
//     return new Return(stream);
//   case 'I':
//     return new Inventory(); // no stream needed
//   case 'H':
//     return new History(stream);
//   default:
//     cerr << "Invalid command type: " << commandType << " in line: " << line
//          << endl;
//     return nullptr;
//   }
// }
